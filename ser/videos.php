...
?>
  <?php
    ...
    echo "<li>";
        ...
        echo "<div class='box'>";
            echo "<a href='loadmovie.php?mname=content/videos/$folderName/" . $moviename . "'>";
                echo "<img src='content/poster/videos/$folderName/" . $file . "' class='model' loading='lazy'>";
                echo "</a>";
            echo "</div>";
        echo "</li>";
      ...
      <div class="movietype">
        <div class="col-xs-12">
          ...
          <ul id="autoWidth1" class="cs1-hidden">
            <?php generateMovieList('content/poster/videos/hindi/'); ?>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="movietype">
        <div class="col-xs-12">
          ...
          <ul id="autoWidth2" class="cs2-hidden">
            <?php generateMovieList('content/poster/videos/english/'); ?>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="movietype">
        <div class="col-xs-12">
          ...
          <ul id="autoWidth3" class="cs3-hidden">
            <?php generateMovieList('content/poster/videos/regional1/'); ?>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="movietype">
        <div class="col-xs-12">
          ...
          <ul id="autoWidth4" class="cs4-hidden">
            <?php generateMovieList('content/poster/videos/regional2/'); ?>
          </ul>
        </div>
      </div>
    </div>
