            ...
            function l(o) {
                return this.each(function() {
                    var t = a(this),
                        ...
                        i = a.extend({}, r.DEFAULTS, t.data(), 'object' == typeof o && o) !e && i.toggle && /show|hide/.test(o) && (i.toggle = !1),
                ...
                if (
                    ...
                    if (
                        ...
                        if (n.length) {
                            ...
                            38 == t.which && 0 < s && s--,
                                40 == t.which && s < n.length - 1 && s++, ~s || (s = 0),
        ...
        (function(g) {
                ...
                if (
                    ...
                    if (
                        (clearTimeout(e.timeout),
                            (e.hoverState = 'in'), !e.options.delay || !e.options.delay.show)
                    )
                        return e.show()
                ...
                if (
                    (e ||
                        ((e = new this.constructor(
                            ...
                            g(t.currentTarget).data('bs.' + this.type, e)),
                        t instanceof g.Event &&
                        (e.inState['focusout' == t.type ? 'focus' : 'hover'] = !1), !e.isInStateTrue())
                ) {
                    if (
                        (clearTimeout(e.timeout),
                            (e.hoverState = 'out'), !e.options.delay || !e.options.delay.hide)
                    )
                        return e.hide()
                    e.timeout = setTimeout(function() {
            ...
            (m.prototype.applyPlacement = function(t, e) {
                ...
                var r = i[0].offsetWidth,
                    l = i[0].offsetHeight 'top' == e && l != n && (t.top = t.top + n - l)
            ...
            (m.prototype.getPosition = function(t) {
                ...
                var n = window.SVGElement && e instanceof window.SVGElement,
                    ...
                    a = {
                        scroll: i ?
                            document.documentElement.scrollTop || document.body.scrollTop : t.scrollTop()
                    },
                    r = i ? { width: g(window).width(), height: g(window).height() } :
                    null
                return g.extend({}, o, a, r, s)
            }),
            (m.prototype.getCalculatedOffset = function(t, e, i, o) {
                return 'bottom' == t ? { top: e.top + e.height, left: e.left + e.width / 2 - i / 2 } :
                    'top' == t ? { top: e.top - o, left: e.left + e.width / 2 - i / 2 } :
        ...
        (function(r) {
            ...
            (a.prototype.show = function() {
                var t = this.element,
                    ...
                    i = t.data('target')
                if (
                    (i || (i = (i = t.attr('href')) && i.replace(/.*(?=#[^\s]*$)/, '')), !t.parent('li').hasClass('active'))
                ) {
                    ...
                    if (
                        (o.trigger(n),
                            t.trigger(s), !s.isDefaultPrevented() && !n.isDefaultPrevented())
                    ) {
