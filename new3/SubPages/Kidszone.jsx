...
const Kidszone = () => {
  ...
  const renderPosters = (category) => {
    ...
    return videos.map((video, index) => {
      ...
      const jpgPosterPath = `${serverIp}/kidszone/${category}/${videoName.replace('.mp4', '.jpg')}`;
      const pngPosterPath = `${serverIp}/kidszone/${category}/${videoName.replace('.mp4', '.png')}`;
