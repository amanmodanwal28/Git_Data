...
const Movies = () => {
  ...
  const renderPosters = (category) => {
    ...
    return videos.map((video, index) => {
      ...
      const jpgPosterPath = `${serverIp}/movies/${category}/${videoName.replace('.mp4', '.jpg')}`;
      const pngPosterPath = `${serverIp}/movies/${category}/${videoName.replace('.mp4', '.png')}`;
        ...
        {selectedCategory && (
          <>
            <div className="type-heading">
              <h2>Movies in {capitalizeFirstLetter(selectedCategory)}:</h2>
            </div>
            <div
